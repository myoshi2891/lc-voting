...
@endif" x-show="isOpen"
    ...
    class="z-20 flex fixed justify-between max-w-xs sm:max-w-sm max-w-sm w-full bottom-0 right-0 bg-white rounded-xl shadow-lg border px-4 py-5 mx-2 sm:mx-6 my-8">
