...
<body class="font-sans bg-gray-background text-grey-900 text-sm">
    ...
    <main class="container mx-auto max-w-custom flex" style="max-width:1000px">
        <div class="w-70 mr-5">
            Add idea form goes here. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis iusto voluptatibus
            officiis aliquid corrupti itaque iure nihil, suscipit quaerat ea eum illo voluptas! Repellendus, tempora!
            Nam fugiat deserunt alias! Voluptas cupiditate id quae animi quo quam molestias nam dolorem harum.
        </div>
        <div class="w-175">
