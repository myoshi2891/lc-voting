            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                        <div class="hidden md:block font-bold text-gray-900">{{ $idea->user->name ?? 'joe doe' }}
                        </div>
                        ...
                        @auth
                            ...
                            shadow-dialog rounded-xl z-10 py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0">
                                    ...
                                    $dispatch('custom-show-mark-idea-as-not-spam-modal')"
                                                    class="hover:bg-gray-100 block transition duration-150 ease-in py-3 px-5">Not
                                                    Spam
                                                </a>
                                            </li>
                                        @endif
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @if ($hasVoted)
                <button type="button" wire:click.prevent="vote"
                    class="h-11 w-32 text-xs bg-blue text-white
