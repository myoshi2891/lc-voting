<div class="relative" x-data="{ isOpen: false }" x-init="window.livewire.on('statusWasUpdated', () => {
    isOpen = false
})">
        ...
        <form wire:submit.prevent="setStatus" action="#" class="space-y-4 px-4 py-6">
            <div class="space-y-2">
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" type="radio" checked=""
                            class="bg-slate-200 text-black border-none" name="radio-direct" value="1">
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" type="radio" checked=""
                            class="bg-slate-200 text-purple border-none" name="radio-direct" value="2">
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" type="radio" checked=""
                            class="bg-slate-200 text-yellow border-none" name="radio-direct" value="3">
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" type="radio" checked=""
                            class="bg-slate-200 text-green border-none" name="radio-direct" value="4">
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" type="radio" checked=""
                            class="bg-slate-200 text-red border-none" name="radio-direct" value="5">
        ...
        transition duration-150 ease-in px-6 py-3 disabled:opacity-50">
            ...
            <div>
                <label class="font-normal inline-flex items-center">
                    <input wire:model="notifyAllVoters" class="rounded bg-gray-200" name="notify_voters"
                        type="checkbox">
