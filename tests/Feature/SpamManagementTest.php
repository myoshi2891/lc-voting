...
class SpamManagementTest extends TestCase
{
   ...
   * @test
   */
  public function does_not_shows_mark_idea_as_spam_livewire_component_when_user_does_not_have_authorization()
  {
    $user = User::factory()->create();
    $idea = Idea::factory()->create();
   ...
   * @test
   */
  public function does_not_show_mark_idea_as_not_spam_livewire_component_when_user_does_not_authorization()
  {
    $idea = Idea::factory()->create();
